...
from sklearn.preprocessing import LabelEncoder, StandardScaler
def home():
    st.title("Predict Recommend Games")
    st.subheader("Purpose")
    st.write("The purpose of this project is to predict recommend games to users based on their preferences.")
    st.subheader("Problem Type")
    st.write("This is a classification problem.")
    st.subheader("Source Data")
    st.write("This dataset comes from https://www.kaggle.com/datasets/anandshaw2001/video-game-sales")
    st.subheader("Data")
    ...
    st.subheader("Model")
    st.write("We will be using the K-Means algorithm to train our model.")
    st.write("The K-Means algorithm is a clustering algorithm that divides the data into K clusters.")
    st.write("We will also be using the DBSCAN algorithm to train our model.")
    st.write("The DBSCAN algorithm is a density-based clustering algorithm that divides the data into clusters based on density.")
    st.subheader("Evaluation")
    st.write("We will be using the accuracy score to evaluate our model.")
    st.write("The accuracy score is the proportion of correct predictions made by the model.")
    st.subheader("Deployment")
    st.write("We will be deploying our model using the Streamlit library.")
...
def main():
    page = st.sidebar.selectbox("Choose a page", ["Predict Recommend Games", "Recommend Games", "E-Test", "Test"])
    if page == "Predict Recommend Games":
        home()
